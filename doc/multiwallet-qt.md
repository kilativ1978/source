...
In order to support loading of multiple wallets in ggp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ggp.cpp.
...
Changes to ggp.cpp
----------------------
ggp.cpp is the entry point into ggp-qt, and as such, will require some minor modifications to provide hooks for
