...
GGP now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ggp_address\> \<monthly_payment_ggp\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GGP, _12_ times over the course of a year totaling _24000_ GGP.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<ggp_address\> \<monthly_payment_ggp\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` GGP.
 ...
 * vote-many          - Vote on a GGP initiative
 * vote-alias         - Vote on a GGP initiative
 * vote               - Vote on a GGP initiative/budget
