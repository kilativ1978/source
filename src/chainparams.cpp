...
{
    const char* pszTimestamp = "GamingGoProject";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
		(0, uint256("0x000008668fdf2927991b7ebc09ca94c619c8012085372755045b1ff12464605d"))
		;
...
public:
    CMainParams()
    {
        ...
        nMasternodeColleteralLimxDev = 4000;
        nModifierUpdateBlock = 1;
        nMaxMoneyOut = 101000000 * COIN;
		
        genesis = CreateGenesisBlock(1551109550, 20819137, 0x1e0ffff0, 1, 0 * COIN);

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x000008668fdf2927991b7ebc09ca94c619c8012085372755045b1ff12464605d"));
        assert(genesis.hashMerkleRoot == uint256("0xfd7ea0bbfd645577bd38d5674c330760df52254935e05f22318c18d4de6166a3"));
		
	vSeeds.push_back(CDNSSeedData("s1.gaminggo.io", "s1.gaminggo.io"));
	vSeeds.push_back(CDNSSeedData("s2.gaminggo.io", "s2.gaminggo.io"));
	vSeeds.push_back(CDNSSeedData("s3.gaminggo.io", "s3.gaminggo.io"));
	...
	nStartMasternodePayments = 1551109550; 
