                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GAMINGGOPROJECT-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GGP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ggp: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GGP Core"), this);
    aboutAction->setStatusTip(tr("Show information about GGP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GGP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GGP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GGP addresses"));
    ...
    openAction->setStatusTip(tr("Open a GGP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GGP Core help message to get a list with possible GGP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GGP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GGP network", "", count));
}
...
{
    QString strTitle = tr("GGP Core"); // default title
