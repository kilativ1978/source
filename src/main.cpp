...
#if defined(NDEBUG)
#error "GGP cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "GGP Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight > 1 && nHeight <= 17234) {
		nSubsidy = 1 * COIN;
	} else if (nHeight > 17234 && nHeight <= 177897) {
		nSubsidy = 38 * COIN;
	} else if (nHeight > 177897) {
		nSubsidy = 22 * COIN;
	}
    return nSubsidy;
}
