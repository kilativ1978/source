...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GGP features */
        {"ggp", "masternode", &masternode, true, true, false},
        {"ggp", "masternodelist", &masternodelist, true, true, false},
        {"ggp", "mnbudget", &mnbudget, true, true, false},
        {"ggp", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ggp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ggp", "mnsync", &mnsync, true, true, false},
        {"ggp", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ggpd, or the -server option to ggp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ggp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17235/\n";
}
