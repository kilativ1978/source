...
RESOURCES += src/qt/ggp.qrc src/qt/ggp_locale.qrc

TRANSLATIONS += src/qt/locale/ggp_bg.ts \
                src/qt/locale/ggp_de.ts \
                src/qt/locale/ggp_en.ts \
                src/qt/locale/ggp_es.ts \
                src/qt/locale/ggp_fi.ts \
                src/qt/locale/ggp_fr.ts \
                src/qt/locale/ggp_it.ts \
                src/qt/locale/ggp_ja.ts \
                src/qt/locale/ggp_pl.ts \
                src/qt/locale/ggp_pt.ts \
                src/qt/locale/ggp_ru.ts \
                src/qt/locale/ggp_sk.ts \
                src/qt/locale/ggp_sv.ts \
                src/qt/locale/ggp_vi.ts \
                src/qt/locale/ggp_zh_CN.ts \
                src/qt/locale/ggp_zh_TW.ts
